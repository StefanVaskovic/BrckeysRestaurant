<?php
    ...
    if(isset($_POST['btnUpdate'])){
        ...
        $query1 = "UPDATE food SET name=?,description=?,oldPrice=?,newPrice=?,recommended=?,idCategory=? WHERE idFood=?";
        ...
        try {
            ...
            $successFood = $stmt1->execute([$name,$description,$oldPrice,$newPrice,$recommended,$idCategory,$idFood]);
