$(document).ready(function(){
    ...
    $("#ddlEventIsActive").on("change",showDateAndTime);



    let ddlValueEvent = $("#ddlEventIsActive").val();
    let dateEvent = $("#eventDateUpdate").val();
    let timeEvent = $("#eventTimeUpdate").val();
    ...
    function showDateAndTime(){
        ...
        $("#eventDateUpdate").val(dateEvent);
        $("#eventTimeUpdate").val(timeEvent);
    }
