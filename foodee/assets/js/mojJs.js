$(document).ready(function () {
            ...
            for (let foodItem of data.food) {
                if (foodItem.catName == catItem.name) {
                    ...
                    <li>
                        ...
                        ${foodItem.newPrice == "0.00" ||  foodItem.newPrice == null ? foodItem.oldPrice : foodItem.currentPrice }
                        </div>
                    </li>`
                }
            }
    ...
    function validateAndRegister() {
        ...
        let nameSurnameRegex = /^[A-ZŽŠČĆŠĐ][a-zčćžđšč]{1,29}(\s[A-ZŽŠČĆŠĐ][a-zčćžđšč])?$/;
        let emailRegex = /^[\wčćžđšč][\w\_\-\.\d]+\@[\w]+(\.[\w]+)?(\.[a-z]{2,3})$/;
