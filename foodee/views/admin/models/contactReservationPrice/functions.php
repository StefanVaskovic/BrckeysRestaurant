<?php
    require_once ABSOLUTE_PATH."views/admin/models/functions.php";

    function getReservationInfo(){
        $query = "SELECT u.idUser,u.name as userName,u.surname as userSurname,u.email,o.name as occasionName,rfu.*,rfi.*,rfo.* FROM user u INNER JOIN reservationform_user rfu ON u.idUser = rfu.idUser INNER JOIN reservationfinal rfi ON rfu.idRFU = rfi.idRFU INNER JOIN reservationform rfo ON rfu.idReservationForm = rfo.idReservationForm INNER JOIN occasion o ON o.idOccasion = rfo.idOccasion";
